...
import com.github.ixre.tto.demo.repo.axq.AxqStaffJpaRepository;
...
public class AxqStaffServiceImpl implements IAxqStaffService{
    ...
    public Error saveStaff(AxqStaffEntity e){
         return Standard.tryCatch(()-> {
            ...
            dst.setDeptId(e.getDeptId());
            dst.setJobId(e.getJobId());
            dst.setIsAdmin(e.getIsAdmin());
            dst.setAccessExtraJson(e.getAccessExtraJson());
