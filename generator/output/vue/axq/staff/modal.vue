<template>
  <div class="mod-form-container">
    <el-form ref="formRef" class="mod-form" size="small"
        ...
        <el-row :gutter="15">
        <el-col :md="12" :xs="24">
            <el-form-item class="mod-form-item" label-position="left" label-width="85px" label="DeptId:" prop="deptId">
            <el-input v-model.number="formData.deptId" class="mod-form-input" autosize placeholder="请输入DeptId"/>
                <span class="mod-form-remark"></span>
            </el-form-item>
          </el-col>
        <el-col :md="12" :xs="24">
            <el-form-item class="mod-form-item" label-position="left" label-width="85px" label="JobId:" prop="jobId">
            <el-input v-model.number="formData.jobId" class="mod-form-input" autosize placeholder="请输入JobId"/>
                <span class="mod-form-remark"></span>
            </el-form-item>
          </el-col>
        <el-col :md="12" :xs="24">
            <el-form-item class="mod-form-item" label-position="left" label-width="85px" label="IsAdmin:" prop="isAdmin">
            <el-checkbox v-model="formData.isAdmin"></el-checkbox>
                <span class="mod-form-remark"></span>
            </el-form-item>
          </el-col>
        <el-col :md="12" :xs="24">
            <el-form-item class="mod-form-item" label-position="left" label-width="85px" label="AccessExtraJson:" prop="accessExtraJson">
            <el-input v-model="formData.accessExtraJson" class="mod-form-input" autosize placeholder="请输入AccessExtraJson"/>
                <span class="mod-form-remark"></span>
            </el-form-item>
          </el-col>
        <el-col :md="12" :xs="24">
